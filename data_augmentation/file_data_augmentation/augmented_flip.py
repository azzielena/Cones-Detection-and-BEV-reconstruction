...
base_path = r'Dataset_Nuovi\dataset_ruotato_ELE'
...
y_cones_file = "Dataset_Nuovi/dataset_finale_ELE/yellow_cones.dat"
save_all_transformed_data(y_cones_file, y_cones_transformed_data, yellow_cones)

y_curve_file = "Dataset_Nuovi/dataset_finale_ELE/yellow_curve.dat"
save_all_transformed_data(y_curve_file, y_curve_transformed_data,yellow_curve)

b_cones_file = "Dataset_Nuovi/dataset_finale_ELE/blue_cones.dat"
save_all_transformed_data(b_cones_file, b_cones_transformed_data,blue_cones)

b_curve_file = "Dataset_Nuovi/dataset_finale_ELE/blue_curve.dat"
save_all_transformed_data(b_curve_file, b_curve_transformed_data,blue_curve)

center_file = "Dataset_Nuovi/dataset_finale_ELE/center_curve.dat"
