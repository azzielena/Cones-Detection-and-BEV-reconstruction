...
base_path = r'New Dataset\sequenze\bev_proj'
...
# Lettura dei file
yellow_cones = load_dat_file(os.path.join(base_path, 'yellow_cones_bev.dat'))
blue_cones = load_dat_file(os.path.join(base_path, 'blue_cones_bev.dat'))
yellow_curve = load_dat_file(os.path.join(base_path, 'yellow_curve_bev.dat'))
blue_curve = load_dat_file(os.path.join(base_path, 'blue_curve_bev.dat'))
center_curve = load_dat_file(os.path.join(base_path, 'center_curve_bev.dat'))
